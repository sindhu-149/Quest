!function (a, b, c, d) {
    ...
    e.prototype.optionsLogic = function () {
        this
            .$element
            .toggleClass("owl-center", this.settings.center),
    ...
    e.prototype.refresh = function () {
        ...
        this
            .$stage
            .addClass("owl-refresh"),
        this.update(),
        this
            .$stage
            .removeClass("owl-refresh"),
    ...
    e.prototype.internalEvents = function () {
        ...
        this.settings.mouseDrag
            ...
            : this
                .$element
                .addClass("owl-text-select-on"),
        this.settings.touchDrag && !c && this
            .$stage
            .on("touchstart touchcancel", a.proxy(function (a) {
                this.eventsRouter(a)
            }, this)),
    ...
    e.prototype.onDragStart = function (d) {
        ...
        a(c).on("mousemove.owl.dragEvents mouseup.owl.dragEvents touchmove.owl.dragEvents touchen" +
                "d.owl.dragEvents",
        a.proxy(function (a) {
            this.eventsRouter(a)
        }, this))
    ...
    e.prototype.replace = function (b) {
        ...
        b.filter(function () {
            return 1 === this.nodeType
                ...
                this
                    ._mergers
                    .push(1 * b.find("[data-merge]").andSelf("[data-merge]").attr("data-merge") || 1)
            }, this)),
    ...
    e.prototype.addTriggerableEvents = function () {
        ...
        a.each({
            ...
            this
                .$element
                .on(a + ".owl.carousel", b(c, a + ".owl.carousel"))
        }, this))
    },
    ...
    e.prototype.destroy = function () {
        this
            .$element
            .hasClass(this.settings.themeClass) && this
            .$element
    ...
    var b = function (c) {
        ...
        this._handlers = {
            ...
            "loaded.owl.lazy": a.proxy(function (a) {
                this._core.settings.autoHeight && a
                    .element
                    .closest("." + this._core.settings.itemClass) === this
                    ._core
                    .$stage
                    .children()
...
function (a, b, c) {
    ...
    d.prototype.play = function (b) {
        ...
        "youtube" === g.type
            ...
            : "vimeo" === g.type && (c = '<iframe src="http://player.vimeo.com/video/' + g.id + '?autoplay=1" width="' + h + '" height="' + i + '" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></ifr' +
                    'ame>'),
    ...
    d.prototype.isInFullScreen = function () {
        ...
        return d && a(d)
            .parent()
            .hasClass("owl-video-frame") && (this._core.speed(0), this._fullscreen = !0),
...
function (a, b, c, d) {
    ...
    e.prototype.swap = function () {
        if (1 === this.core.settings.items && this.core.support3d) {
            ...
            this
                .core
                .current() !== this.previous && (g && (b = this.core.coordinates(this.previous) - this.core.coordinates(this.next), d.css({
                left: b + "px"
...
function (a) {
    ...
    var b = function (c) {
        ...
        this._handlers = {
            "prepared.owl.carousel": a.proxy(function (b) {
                this._core.settings.dotsData && this
                    ._templates
                    .push(a(b.content).find("[data-dot]").andSelf("[data-dot]").attr("data-dot"))
            }, this),
            "add.owl.carousel": a.proxy(function (b) {
                this._core.settings.dotsData && this
                    ._templates
                    .splice(b.position, 0, a(b.content).find("[data-dot]").andSelf("[data-dot]").attr("data-dot"))
            }, this),
            ...
            "refreshed.owl.carousel": a.proxy(function () {
                ...
                this
                    ._core
                    .trigger("refresh", null, "navigation"),
                this.update(),
                this.draw(),
                this
                    ._core
